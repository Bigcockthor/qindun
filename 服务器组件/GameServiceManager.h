...
public:
	//释放对象
	virtual bool __cdecl Release() {return false; }
	//是否有效
...
public:
	//获取属性
	virtual void __cdecl GetGameServiceAttrib(tagGameServiceAttrib & GameServiceAttrib){GameServiceAttrib=m_GameServiceAttrib;return;}
	//修改参数
